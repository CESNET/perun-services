...
class UrlJsonDestination(Destination):
    def __init__(self, destination: str, service_name: str, facility_name: str):
        # Ensure that data was generated by generic_json_gen
        gen_lookup_path = os.path.join(
        ...
        if not os.path.isfile(gen_lookup_path):
            raise ValueError(
                "UrlJsonTransport only supports data generated by 'generic_json_gen' script."
            )
        super().__init__(destination, service_name, facility_name)
