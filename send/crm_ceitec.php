...
$client = new SoapClient(
    "https://wcf3.ceitec.cz/ExternalWWW.WCFService.svc?wsdl",
    array('login' => $l, 'password' => $p, 'trace' => 'true')
);
...
# public string[] CreateUser (
    ...
    # string email, string orgUnit, string universityId,
    # string eppn , string rgs, string alternativeLoginNames
# )
